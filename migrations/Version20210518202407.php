 ...
 */
final class Version20210518202407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book_category (id INT AUTO_INCREMENT NOT NULL, id_book_id INT DEFAULT NULL, id_category_id INT DEFAULT NULL, INDEX IDX_1FB30F98C83F1AF1 (id_book_id), INDEX IDX_1FB30F98A545015 (id_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
